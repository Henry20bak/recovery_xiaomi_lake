...
# Vendor boot specific flags
FOX_VENDOR_BOOT_RECOVERY := true
FOX_RECOVERY_VENDOR_BOOT_PARTITIONS := vendor_boot

# HyperOS compatibility flags
FOX_USE_NANO_EDITOR := true
FOX_USE_TAR_BINARY := true
FOX_USE_SED_BINARY := true
OF_AVOID_LEGACY_EXFAT_SCAN := true
